...
module.exports.handler = async event => {
	...
	try{
		...
		let html = `<div><h2 style="text-align: center;color: #8396d3; font-family: Arial;">¡Nueva modificación realizada en Al Alza!<br></h2><p style="text-align: center;"><strong>Repositorio:</strong> ${repositoryName} <br></p><p style="text-align: center;"><strong>Descripción:</strong> ${message} <br></p><p style="text-align: center;"><strong>Autor:</strong> ${author.name} <br></p></div>`
		let params = {
			html: html,
			from: "Al Alza <no-reply@alalza.mx>",
			to: `cabello.acosta.gerardo@gmail.com;investus.ifc@gmail.com`,
			subject: "Modificación realizada en el sistema | Al Alza"
		}
